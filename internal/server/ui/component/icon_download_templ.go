...
// IconDownload renders a download-arrow glyph. The class string is applied to
// the root <svg> element so callers can size and colour the icon (e.g.
// "h-4 w-4 text-white").
func IconDownload(class string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/server/ui/component/icon_download.templ`, Line: 1, Col: 0}
		}
