...
func TestEngine_Pause(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockClient.EXPECT().Torrent(testInfoHash()).Return(mockTorrent, true).Once()
		mockTorrent.EXPECT().DisallowDataDownload().Return().Once()
		mockTorrent.EXPECT().DisallowDataUpload().Return().Once()
		...
		require.NoError(t, engine.Pause(t.Context(), testInfoHashHex))
	})
...
func TestEngine_Resume(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockClient.EXPECT().Torrent(testInfoHash()).Return(mockTorrent, true).Once()
		mockTorrent.EXPECT().AllowDataDownload().Return().Once()
		mockTorrent.EXPECT().AllowDataUpload().Return().Once()
		...
		require.NoError(t, engine.Resume(t.Context(), testInfoHashHex))
	})
